...
package com.example.simanishi.fuufuu.awsS3.network;
...
import com.example.simanishi.fuufuu.awsS3.models.UploadModel;
import com.example.simanishi.fuufuu.awsS3.util.Util;
...
public class NetworkService extends IntentService {
        ...
        if (intent != null && intent.getAction() != null) {
            if (intent.getAction().equals(Intent.ACTION_GET_CONTENT) &&
                ...
                download(intent.getStringArrayExtra(S3_KEYS_EXTRA));
                    ...
                    intent.getData() != null) {
                upload(intent.getData(), intent.getExtras().getString("saveDir"));
    ...
    private void upload(Uri uri, String saveDir) {
        UploadModel model = new UploadModel(this, uri, mTransferManager, saveDir);
