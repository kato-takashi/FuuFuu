...
import com.example.simanishi.fuufuu.awsS3.models.DownloadModel;
import com.example.simanishi.fuufuu.awsS3.models.TransferModel;
import com.example.simanishi.fuufuu.awsS3.models.TransferModel.Status;
import com.example.simanishi.fuufuu.awsS3.network.TransferController;
...
public class TransferView extends LinearLayout {
    ...
    private int telProgressNum = 0;

    public TransferView(Context context, TransferModel model) {
        super(context);
//        LayoutInflater.from(context).inflate(R.layout.transfer_view, this, true);
...
//        mAbort.setImageResource(R.drawable.x);
    ...
    public int telProgress(){
        telProgressNum = mModel.getProgress();
        return telProgressNum;
    }
...
//                leftRes = R.drawable.play;
                ...
                mPause.setVisibility(View.GONE);
                mAbort.setVisibility(View.GONE);
                Toast.makeText(getContext(), "AWS送信　完了", Toast.LENGTH_SHORT).show();
                telProgressNum = 0;
